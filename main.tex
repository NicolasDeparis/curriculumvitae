...
\homepage{https://github.com/NicolasDeparis}
\extrainfo{DOB 24/05/1986 - 31 years old}
...
\cvitem{API}{MPI,CUDA,OpenMP,HDF5,OpenGL}
\cvitem{Tools}{Git, Valgrind}
%\cvitem{Others}{Photoshop, Blender, Unreal Engine 4}
\cvitem{Known HPC centers}{PRACE TGCC Curie (Fance), PRACE CINES Occigen (France), OLCF Titan (USA) }
...
%\cvitem{Dominique Aubert}{ \\\\11 rue de l'université\\67000 Strasbourg France\\ \emailsymbol dominique.aubert@unistra.fr}
%\vspace{5pt}
%
%\cvitem{Pierre Ocvirk}{ \\Observatoire de Strasbourg\\11 rue de l'université\\67000 Strasbourg France\\ \emailsymbol pierre.ocvirk@astro.unistra.fr}
%
\begin{tabular}{lr}
% Referee 1
...
%\cvitem {\textit{Reionization powered by GPUs II. \emma, an AMR cosmological simulation code with radiative transfer}}{avec Dominique Aubert et Pierre Ocvirk a paraître dans Monthly Notices of the Royal Astronomical Society}


%\item \textit{Immersive-3D visualization of astronomical data}, 
%Andre Schaaf et al. présentation  a ADASS 2014
%\end{itemize}
